...
/**
 * The Flow mark, inlined and tinted with the active theme.
 *
 * Same approach as Ledger / portfolio: proxy the SVG, drop the canvas, and
...
function initials(name: string): string {
  ...
  return (parts[0]?.slice(0, 2) ?? "NF").toUpperCase();
}
